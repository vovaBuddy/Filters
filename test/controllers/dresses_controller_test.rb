...
class DressesControllerTest < ActionController::TestCase
  ...
  test "should create dress" do
    assert_difference('Dress.count') do
      post :create, dress: { brand: @dress.brand, color: @dress.color, image: @dress.image, length: @dress.length, name: @dress.name, price: @dress.price, type: @dress.type }
    end
  ...
  test "should update dress" do
    patch :update, id: @dress, dress: { brand: @dress.brand, color: @dress.color, image: @dress.image, length: @dress.length, name: @dress.name, price: @dress.price, type: @dress.type }
    assert_redirected_to dress_path(assigns(:dress))
  end
